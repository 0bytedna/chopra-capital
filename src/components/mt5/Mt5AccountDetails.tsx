    ...
    <dl className="grid sm:grid-cols-2">
      {details.map(([label, value], index) => (
        <div
          key={label}
          className={cn(
            "grid min-w-0 grid-cols-[7.5rem_minmax(0,1fr)] items-center gap-2 px-4 py-2.5",
        ...
        >
          ...
          <dd className="grid min-w-0 grid-cols-[minmax(0,1fr)_1.75rem] items-center gap-2">
            <span className="min-w-0 break-words font-mono text-[13px] leading-5 text-ink sm:text-sm">
              {value}
            </span>
