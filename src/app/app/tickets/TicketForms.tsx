...
export function NewTicketDialog() {
  ...
  return (
    <>
      ...
      <dialog
        ref={dialogRef}
        className="fixed inset-0 m-auto max-h-[90svh] w-[calc(100%-2rem)] max-w-xl overflow-y-auto rounded-2xl border border-slate-200 bg-white p-0 text-ink shadow-2xl backdrop:bg-slate-950/55 backdrop:backdrop-blur-sm"
      >
        <div className="p-5 sm:p-6">
          <div className="mb-5 flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="flex size-9 shrink-0 items-center justify-center rounded-full border border-slate-200 text-ink-dim transition-colors hover:bg-slate-50 hover:text-ink"
            >
