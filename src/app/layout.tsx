...
export const metadata: Metadata = {
  ...
  title: {
    default: "Chopra Capital - We Don't Predict Gold, We Hedge It",
  ...
  openGraph: {
    title: "Chopra Capital - We Don't Predict Gold, We Hedge It",
    description: "Automated gold trading with human oversight.",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "Chopra Capital - We Don't Predict Gold, We Hedge It" }],
  },
  twitter: {
